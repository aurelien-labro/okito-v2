    ...
    <div>
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-stone-500">Gestion multi-tenant — admin uniquement.</p>
        </div>
        <button
          type="button"
      ...
      <div className="mt-6 overflow-hidden rounded-lg border border-stone-200 bg-white">
        {loading ? (
          ...
          <div className="p-8 text-center text-sm text-stone-500">Aucun tenant.</div>
        ) : (
              ...
              {tenants.map((t) => (
                <tr key={t.id} className="border-t border-stone-100">
                  ...
                  <td className="px-4 py-3 text-stone-600">
                    <code className="rounded bg-stone-100 px-1 py-0.5 text-xs">{t.slug}</code>
                  </td>
